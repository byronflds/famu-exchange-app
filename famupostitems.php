...
<div data-role="page">
  ...
  <div data-role="navbar">
   ...
   <form method="post" action="famupostitem.php">
      <div class="ui-field-contain">
        <label for="itemname">Item name:</label>
        <input type="text" name="itemname" id="itemname">       
        <label for="itemprice">Price:</label>
        <input type="number" step="any" name="itemprice" id="itemprice">
        <label for="itemdescription">Description:</label>
        <input type="text" name="itemdescription" id="itemdescription">       
      </div>
      <input type="submit" name = "submititem" data-inline="true" value="Submit">
    </form>
